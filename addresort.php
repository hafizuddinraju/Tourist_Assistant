...
<header class="site-headers">
    ...
    <div>
        <form action="addresortinsert.php" method="POST">
            <div class="container">
                <h1>Add Resort</h1>
                <p></p>
                <br>
                <label for="resortName"><b>Resort Name </b></label>
                <input type="text" name="resortName" placeholder="Enter Resort Name">
  ...
  <br>
                ...
                <label for="resortLocation"><b>Location</b></label><br>
                <input type="text" name="resortLocation" placeholder="Enter Resort Location">
                ...
                <br><center> <button onclick="window.location.href='addresortinsert.php'">Submit</button></center><br>
            </div>
        </form>
    </div>
</body>
