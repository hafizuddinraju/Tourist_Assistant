...
<header class="site-headers">
		<nav>
			...
			<div class="Menu">
				...
				<ul>
				<a class="navbar-brand" href="index.html"><h1><p style="color:white">Tourist Assistant</p></h1></a>
					...
					<li><a href="resorts.html"><i class="fa fa-home"></i>Resorts</a>
					<div class="sub-menu-1">
					...
					<li><a href="feedback.php"><i class="fa fa-phone"></i>Feedback</a></li>
                    ...
                    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="images\cox1.jpg" class="d-block w-100" alt="...">
                        ...
                        <div class="carousel-item">
                          <img src="images\k_1.jpg" class="d-block w-100" alt="...">
                          <div class="carousel-caption d-none d-md-block">
                            <h5></h5>
                            <p></p>
                          </div>
                        ...
                        <div class="carousel-item">
                          <img src="images\saint1.jpg" class="d-block w-100" alt="...">
                          <div class="carousel-caption d-none d-md-block">
                            <h5></h5>
                            <p></p>
                          </div>
						...
						<div class="carousel-item">
                          <img src="images\kuakata2.jpg" class="d-block w-100" alt="...">
                          <div class="carousel-caption d-none d-md-block">
                            <h5></h5>
                            <p></p>
                          </div>
